...
- [ ] **SubTask 2.3: 实现 GFLOPs_dynamic 估算**
  显式 MoE 的 GFLOPs = 基础 GFLOPs + (avg_topk / K_max) × 专家额外 GFLOPs
  记录到 CSV

- [ ] **SubTask 2.4: 写入统一 CSV**
